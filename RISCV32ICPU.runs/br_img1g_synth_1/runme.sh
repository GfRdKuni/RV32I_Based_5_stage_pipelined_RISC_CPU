...
HD_PWD='D:/Xilinx_Vivado_SDK_2019.1_0524_1430/project/RISCV32ICPU/RISCV32ICPU.runs/br_img1g_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log br_img1g.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source br_img1g.tcl
