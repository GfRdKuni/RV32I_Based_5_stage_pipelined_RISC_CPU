...
HD_PWD='D:/Xilinx_Vivado_SDK_2019.1_0524_1430/project/RISCV32ICPU/RISCV32ICPU.runs/bram_img2r_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_img2r.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_img2r.tcl
